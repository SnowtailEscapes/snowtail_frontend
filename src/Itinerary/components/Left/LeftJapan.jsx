...
const Accordion = lazy(() => import("../Accordions/AccordionJapan.jsx"));
const Common = lazy(() => import("../Common/Top.jsx"));
const Map = lazy(() => import("../Common/Map.jsx"));
const Vietnam = lazy(() => import("../Inclusion/Japan.jsx"));
    ...
    <>
      <div className={a.tour_left}>
        ...
        <div className={a.left4} data-aos="slide-right">
          <h3>Overview</h3>
          <p>
            Japan is a land of timeless beauty, rich history, and vibrant
            culture. Immerse yourself in its stunning cherry blossoms, majestic
            castles, and architectural marvels. Enjoy breathtaking views of
            Mount Fuji and Lake Ashi on the Hakone Ropeway, visit the
            awe-inspiring Great Buddha Hall at Todaiji, marvel at the golden
            splendor of Kinkaku-ji in Kyoto, and experience the futuristic
