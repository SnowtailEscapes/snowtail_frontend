...
import GujaratAccordion from "../../Accordions/Domestic/Lonavala3n4d.jsx";
    ...
    <>
      <div className={`${a.tour_left} {isDarkMode ? 'dark-mode' : 'hehe'}`}>
        ...
        <div className={a.left4} data-aos="slide-right">
          ...
          <p>
            Imagicaa is a 130-acre theme park in Khopoli, Raigad District,
            Maharashtra, India. It is owned by Imagicaa World Entertainment Ltd.
            Imagicaa is listed on the National Stock Exchange and Bombay Stock
            Exchange.
          </p>
          <div>
            <ul>
              <li>Pick up - Mumbai Railway Station / Airport</li>
              <li>Drop - Mumbai Railway Station / Airport</li>
