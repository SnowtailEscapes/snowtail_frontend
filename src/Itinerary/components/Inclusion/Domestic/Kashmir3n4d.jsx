    ...
    <>
      <div className={a.left6} data-aos="zoom-in">
        ...
        <ul>
          ...
          <li>
            <img src={dot} width={5} alt="dot" /> Accommodation: 3N Srinagar.
          </li>
          <li>
            <img src={dot} width={5} alt="dot" /> Meals: 3 Breakfast at selected hotels
          </li>
          <li>
          ...
          <li>
            ...
            Pahalgam :- Betab Valley, Mamleshwar Temple, Aru Valley, Chandanwari or Market for shopping.
          </li>
        </ul>
        <ul>
          <h4>Exclusions</h4>
