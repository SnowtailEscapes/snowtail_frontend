    ...
    <>
        <div className={a.left6} data-aos="zoom-in">
          ...
          <ul>
            ...
            <li>
              <img src={dot} width={5} alt="dot" /> Accommodation : 2 nights in Hanoi, 1 night on Halong Cruise, 2 nights in Da Nang, 2 nights in Phu Quoc, 2 nights in Ho Chi Minh city.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Meals : Breakfast from Day 2 to Day 9 and lunch+dinner on Cruise
            </li>
            <li>
