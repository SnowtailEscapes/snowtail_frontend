    ...
    <>
        <div className={a.left6} data-aos="zoom-in">
          ...
          <ul>
            ...
            <li>
              <img src={dot} width={5} alt="dot" /> Accommodation : Accommodation for 4 nights in Singapore.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Meals : Breakfast from Day 2 to Day 5
            </li>
            <li>
              <img src={dot} width={5} alt="dot" />Sightseeing : Night Safari, Singapore Half Day City Tour, Marina Bay Sands Observation Deck, Gardens By the Bay, Universal Studios & Sentosa Island Trip (Cable Car Ride + Wings of Time)
            </li>
            <li>
