    ...
    <>
        <div className={a.left6} data-aos="zoom-in">
          ...
          <ul>
            ...
            <li>
              <img src={dot} width={5} alt="dot" /> Accommodation : 3 nights accommodation in Phuket and 2 nights accommodation in Krabi.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Meals : Breakfast from Day 2 to Day 6 and lunch on Krabi 4 & Phi Phi Island tour.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" />Flights: 03 internal flights.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" />Sightseeing : Phuket City Tour, Krabi 4 Island Tour & Phi Phi island tour.
            </li>
            <li>
