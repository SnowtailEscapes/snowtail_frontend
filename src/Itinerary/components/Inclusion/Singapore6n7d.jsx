    ...
    <>
        <div className={a.left6} data-aos="zoom-in">
          ...
          <ul>
            ...
            <li>
              <img src={dot} width={5} alt="dot" />Accommodation : Accommodation for 4 nights in Singapore & (2 Nights stay at Genting Dream Cruise with all meals).
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Meals : Breakfast from Day 2 to Day 7
            </li>
            <li>
              <img src={dot} width={5} alt="dot" />Sightseeing : Night Safari, Singapore half day City Tour, Gardens By the Bay, Universal Studios & From afternoon till sunset Sentosa Island Trip (Cable Car Ride)
            </li>
            <li>
