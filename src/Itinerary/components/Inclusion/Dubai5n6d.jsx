...
import a from "../../styles/Tourmain.module.css";2
    ...
    <>
        <div className={a.left6} data-aos="zoom-in">
          ...
          <ul>
            ...
            <li>
              <img src={dot} width={5} alt="dot" /> Accommodation : 5 nights accommodation in Dubai.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Meals : Breakfast from Day 2 to Day 6.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Sightseeing : Dubai & Abu Dhabi City Tour, Dhow Cruise Creek, Abu Dhabi Ferrari World, Burj Khalifa & Desert Safari.
            </li>
            <li>
