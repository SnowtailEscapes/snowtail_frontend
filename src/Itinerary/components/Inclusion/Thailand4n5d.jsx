    ...
    <>
        <div className={a.left6} data-aos="zoom-in">
          ...
          <ul>
            ...
            <li>
              <img src={dot} width={5} alt="dot" /> Accommodation : 2 nights accommodation in Bangkok & 2 nights accommodation in Pattaya.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" /> Meals : Breakfast from Day 2 to Day 5 and lunch on Coral Island tour.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" />Flights: 03 internal flights.
            </li>
            <li>
              <img src={dot} width={5} alt="dot" />Sightseeing : Bangkok City Tour, Coral Island Tour.
            </li>
            <li>
