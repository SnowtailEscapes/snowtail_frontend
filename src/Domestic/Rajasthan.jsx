...
import Small from "../assets/CardImages/Rj7n8dS.webp";
    ...
    <div>
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <section className={a.section} data-aos="zoom-in">
          <ItineraryImage small='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/Small/sajzabk69brdin5l2i9c' large='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/large/mgmgey3ythkls6oj3cfh' />
          <Navbar />
        </section>
        <Tourmain />
        <Contact2 />
