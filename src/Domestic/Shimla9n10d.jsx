...
const Tourmain = lazy(() => import("../Itinerary/components/Tourmain/Domestic/Shimla9n10d"));
  ...
  return (
    ...
    <Helmet>
      ...
      <section className={a.section} data-aos="zoom-in">
          <ItineraryImage small='https://snowtailescapes.com/images/card/shimla9n10d.webp' large={large} />
          <Navbar />
        </section>
        <Tourmain />
        <Contact2 />
