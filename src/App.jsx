...
import { whatsappNumber } from "./constants/data.js";
  ...
  return (
    <div className={isDarkMode ? "dark-mode" : "hehe"}>
      <Router>
        <RouteChangeTracker />
        <div
          className="fixed bottom-10 right-0 w-14 hover:w-20 transition-all duration-500 h-12 py-2 px-3 bg-[#40b14e] bg-opacity-90 z-[99999] rounded-l-xl cursor-pointer"
          onClick={() => window.open(`https://wa.me/${whatsappNumber}`, "_blank")}
        >
          <Icon icon="logos:whatsapp-icon" alt="whatsapp" className="h-8 w-8" />
        </div>
        <Routes>
          {/* COMMON SECTIONS */}
