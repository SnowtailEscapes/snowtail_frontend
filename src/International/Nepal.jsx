...
// Import images
import Large from "../assets/LargeImages/NepalL.avif";
import Small from "../assets/CardImages/nepalS.webp";
    ...
    />
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <section className={a.section} data-aos="zoom-in">
          <ItineraryImage small={Small} large='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/large/eyx3osnokbu32gtoi4hi' />
          <Navbar />
        </section>
        <Tourmain />
        <Contact2 />
