  ...
  return (
    <div>
      ...
      <Suspense fallback={<div>Loading...</div>}>
        ...
        >
          <Navbar />
          <ItineraryImage small='https://snowtailescapes.com/images/card/japan1.webp' large='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/Small/wtjljprxslnhkbi4mvnt' />
        </section>
        <Tourmain />
        <Contact2 />
        <Footer />
