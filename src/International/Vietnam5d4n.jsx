    ...
    />
      ...
      <Suspense fallback={<div>Loading...</div>}>
        <section className={`${a.Vietnam4n5d} ${a.mobile} ${a.window}`} data-aos="zoom-in">
          <Navbar />
          <ItineraryImage small={Vietnam5n4dSmall} large='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/large/km2p7ynbnkxpzxzevjnw' />
        </section>
        <Tourmain />
        <Contact2 />
        <Footer />
