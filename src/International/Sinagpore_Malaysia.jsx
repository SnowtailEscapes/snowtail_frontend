    ...
    <div>
      ...
      <Suspense fallback={<div>Loading...</div>}>
        ...
        <section className={`${a.section} ${a.SM}`} data-aos="zoom-in">
          <ItineraryImage small='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/Small/bgzs32ixxddrhw7q4n5q' large='https://res.cloudinary.com/djbo8r8ic/image/upload/f_auto,q_auto/v1/snowtail%20escapes/large/zwe2civ3gdc4weuldhep' />
        </section>
        <Tourmain />
        <Contact2 />
        <Footer />
